...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-ivory pt-32 pb-24 px-4 lg:px-12 rounded-t-[4rem] relative overflow-hidden z-70 -mt-20">
        ...
        <div className="max-w-[1920px] mx-auto relative z-10 flex flex-col xl:flex-row items-center justify-between gap-12 xl:gap-24">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 shrink-0">
                 <button className="text-sm font-bold text-olive hover:text-olive/70 transition-colors whitespace-nowrap uppercase tracking-widest">Log In</button>
                 <button className="bg-olive text-lime rounded-full px-8 py-4 text-sm font-bold hover:bg-lime hover:text-olive transition-colors uppercase tracking-widest whitespace-nowrap">
                   Start Sourcing
                 </button>
            </div>
        </div>
