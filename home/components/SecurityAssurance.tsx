  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8 items-center">
        <div className="bg-[#1a1c14] border border-white/10 rounded-[2.5rem] p-9 space-y-7 shadow-sharp">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-3xl font-bold text-[#fdfff9] tracking-tight">Quality & compliance on every lane.</h3>
            </div>
          </div>
          <p className="text-[#d5e0bf] leading-relaxed text-lg">
          ...
          <button className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-[#d3f54c] text-[#d3f54c] font-semibold hover:bg-[#d3f54c] hover:text-[#282a1e] transition">
            View QC checklist <ArrowRight size={16} />
          </button>
        </div>

        <div className="bg-[#fdfff9] text-[#1a1c14] rounded-[2.5rem] p-8 border border-[#d3f54c]/30 shadow-sharp-white space-y-7">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold tracking-tight">Trusted handling, transparent proof.</h3>
            </div>
          </div>
          <div className="space-y-4 text-base text-[#1a1c14]">
