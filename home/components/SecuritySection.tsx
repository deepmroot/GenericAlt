...
export const FeaturesGrid: React.FC = () => {
  return (
    <section
      id="solutions"
      className="py-32 px-4 lg:px-12 bg-charcoal relative rounded-t-[4rem] overflow-hidden"
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(#fdfff9 1px, transparent 1px), linear-gradient(90deg, #fdfff9 1px, transparent 1px)',
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <Card
              key={i}
              variant="dark"
              className="group min-h-[400px] flex flex-col justify-between !bg-olive/50 border-white/5 hover:!bg-olive transition-colors relative overflow-visible"
            >
              <div>
                ...
                <h3 className="text-3xl xl:text-4xl font-bold text-ivory mb-6 tracking-tight leading-[1.1]">
                  {f.title}
                </h3>
              ...
              <div className="mt-10 pt-6 border-t border-white/5 flex items-center justify-between">
                <div className="h-1.5 w-12 bg-white/10 rounded-full overflow-hidden">
                  <div className="h-full w-0 bg-lime group-hover:w-full transition-all duration-700 ease-out" />
                </div>
                <span className="text-2xl font-serif italic text-white/10 group-hover:text-lime/50 transition-colors">
                  0{i + 1}
                </span>
              </div>
            </Card>
